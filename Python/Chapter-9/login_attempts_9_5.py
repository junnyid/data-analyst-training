class User:
    ...
    def __init__(self, first_name, last_name, nickname, email, number_phone, login_attempts):
...
dwingarium = User('Dungx', 'Pham', 'Blueberry', 'dwingariumij@gmail.com', '+8487654321', 0)
